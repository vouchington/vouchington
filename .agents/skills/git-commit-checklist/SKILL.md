...
description: Use before staging or committing in Filaments. Loads the portable Vouchington checklist, then applies Filaments validation and hook policy.
---

# Filaments Git Commit Adapter
