---
name: planning
description: Create evidence-backed Filaments implementation plans. Loads the portable Vouchington planning workflow, then applies local Plan issue and validation policy.
---

# Filaments Planning Adapter
...
milestone selection, and post-create verification.
