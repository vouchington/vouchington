...
description: Use when editing a Filaments package manifest or adding a dependency. Loads the portable package-metadata checklist, then applies local workspace policy.
---

# Filaments package.json Adapter
