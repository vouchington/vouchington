...
export const metadata: Metadata = createNoIndexMetadata('My Blocked Domains')

export default async function MyDomainsBlockedPage() {
  const currentUser = await requireCurrentUser()
  return (
    <div
      className='space-y-6'
      data-pw='my-domains-blocked-page'
    >
      <BookmarkPageHeader routeKey='domains/blocked' />
