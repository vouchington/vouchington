...
import MyDomainsMutedPage from './page'

const baseUser = { id: 'user-1', username: 'alice' }

describe('MyDomainsMutedPage', () => {
  beforeEach(() => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(MyDomainsMutedPage()).rejects.toThrow('redirect:/login')
  ...
  it('renders data-pw wrapper when authenticated', async () => {
    ...
    const { container } = render(await MyDomainsMutedPage())
    expect(container.querySelector('[data-pw="my-domains-muted-page"]')).toBeTruthy()
  })
})
