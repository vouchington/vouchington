...
import MyTopicsMutedPage from './page'

const baseUser = { id: 'user-1', username: 'alice' }

describe('MyTopicsMutedPage', () => {
  beforeEach(() => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(MyTopicsMutedPage()).rejects.toThrow('redirect:/login')
  ...
  it('renders data-pw wrapper when authenticated', async () => {
    ...
    const { container } = render(await MyTopicsMutedPage())
    expect(container.querySelector('[data-pw="my-topics-muted-page"]')).toBeTruthy()
  })
})
