...
import MyTopicsViewedPage from './page'

const baseUser = { id: 'user-1', username: 'alice' }

describe('MyTopicsViewedPage', () => {
  beforeEach(() => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(MyTopicsViewedPage()).rejects.toThrow('redirect:/login')
  ...
  it('renders data-pw wrapper when authenticated', async () => {
    ...
    const { container } = render(await MyTopicsViewedPage())
    expect(container.querySelector('[data-pw="my-topics-viewed-page"]')).toBeTruthy()
  })
})
