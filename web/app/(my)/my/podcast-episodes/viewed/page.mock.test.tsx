...
import MyPodcastEpisodesViewedPage from './page'

const baseUser = { id: 'user-1', username: 'alice' }

describe('MyPodcastEpisodesViewedPage', () => {
  beforeEach(() => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(
      MyPodcastEpisodesViewedPage({ searchParams: Promise.resolve({}) }),
  ...
  it('renders the page heading when authenticated', async () => {
    ...
    render(await MyPodcastEpisodesViewedPage({ searchParams: Promise.resolve({}) }))
