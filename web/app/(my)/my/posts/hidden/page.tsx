...
export const metadata: Metadata = createNoIndexMetadata('My Hidden Posts')

export default async function MyPostsHiddenPage() {
  const currentUser = await requireCurrentUser()
  return (
    <div
      className='space-y-6'
      data-pw='my-posts-hidden-page'
    >
      <BookmarkPageHeader routeKey='posts/hidden' />
