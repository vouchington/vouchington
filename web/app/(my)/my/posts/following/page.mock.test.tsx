...
import MyPostsFollowingPage from './page'

const baseUser = { id: 'user-1', username: 'alice' }

describe('MyPostsFollowingPage', () => {
  beforeEach(() => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(MyPostsFollowingPage()).rejects.toThrow('redirect:/login')
  ...
  it('renders data-pw wrapper when authenticated', async () => {
    ...
    const { container } = render(await MyPostsFollowingPage())
    expect(container.querySelector('[data-pw="my-posts-following-page"]')).toBeTruthy()
  })
})
