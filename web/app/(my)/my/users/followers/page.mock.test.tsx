...
import MyUsersFollowersPage from './page'

const baseUser = { id: 'user-1', username: 'alice' }

describe('MyUsersFollowersPage', () => {
  beforeEach(() => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(MyUsersFollowersPage()).rejects.toThrow('redirect:/login')
  ...
  it('renders data-pw wrapper when authenticated', async () => {
    ...
    const { container } = render(await MyUsersFollowersPage())
    expect(container.querySelector('[data-pw="my-users-followers-page"]')).toBeTruthy()
  })
})
