...
import MyUsersSubscribedPostsPage from './page'

const baseUser = { id: 'user-1', username: 'alice' }

describe('MyUsersSubscribedPostsPage', () => {
  beforeEach(() => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(MyUsersSubscribedPostsPage()).rejects.toThrow('redirect:/login')
  ...
  it('renders data-pw wrapper when authenticated', async () => {
    ...
    const { container } = render(await MyUsersSubscribedPostsPage())
    expect(container.querySelector('[data-pw="my-users-subscribed-posts-page"]')).toBeTruthy()
  })
})
