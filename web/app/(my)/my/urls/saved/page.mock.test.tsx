...
describe('MyUrlsSavedPage', () => {
  ...
  it('redirects to /login when not authenticated', async () => {
    ...
    await expect(MyUrlsSavedPage()).rejects.toThrow('redirect:/login')
  ...
  it('renders data-pw wrapper when authenticated', async () => {
    ...
    const { container } = render(await MyUrlsSavedPage())
    expect(container.querySelector('[data-pw="my-urls-saved-page"]')).toBeTruthy()
  })
})
