...
export function CopyrightCounterNoticeForm({
  ...
  return (
    ...
    >
      ...
      <p className='text-sm text-muted-foreground'>
        If accepted, we will forward your name, address, telephone number, electronic signature, and
        declarations to the original claimant or their agent.
      </p>
      <LabeledInput
      ...
      >
        I state under penalty of perjury that I have a good-faith belief the material was removed or
        disabled because of mistake or misidentification.
      </DeclarationCheckbox>
      <TargetScopeSelector
        targetIds={targetIds}
      ...
      >
        I consent to the jurisdiction of the Federal District Court for my address, or if my address
        is outside the United States, any district where Voucha may be found.
      </DeclarationCheckbox>
      <DeclarationCheckbox
      ...
      <Button
        type='submit'
        disabled={
          pending || !complete || selectedTargetIds.length === 0 || !turnstile.token || !declared
        }
      >
