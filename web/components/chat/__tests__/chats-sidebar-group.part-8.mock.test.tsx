...
describe('ChatsSidebarGroup', () => {
  ...
  it('preserves loaded conversations after pathname changes', async () => {
    mockGetMyConversationsClient
      .mockResolvedValueOnce({
        ...
        page_info: makePageInfo(true, 'cursor-abc'),
      })
      .mockResolvedValueOnce({
        results: [
          {
    ...
    await waitFor(() => {
      expect(getByText('Second page chat')).toBeDefined()
    })
