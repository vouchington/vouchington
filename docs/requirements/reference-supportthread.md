...
| ------------- | ------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------- | -------------------------------------------------------------------------------------------- | -------------------------------------------- |
| List / Filter | Search and cursor-page support threads; filter by status (open/assigned/resolved).                                                          | `/support`                   | `web/app/(support-admin)/support/page.tsx`; native staff-support surfaces                    | sidebar: Support → Support; command: Support |
