...
| ------------------------------------------ | ---------------------------- | -------------------------------------------------------------------------------------------------- |
| `/posts/review-queue`                      | Global admin/site moderator  | Global clearance review queue                                                                      |
...
Swift and .NET provide a dedicated global review queue for administrators and site moderators. Both native clients
render the existing post, author, root-thread, provider-neutral disposition, stable reason codes, bounded evidence summary,
