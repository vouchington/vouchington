...
| Unpublish from community             | n/a                       | Community owner/moderator; platform override by Admin/site moderator | n/a                                          |
| Archive / Unarchive                  | Author, Admin             | Author, Admin                                                        | Author, Admin                                |
| Approve / Reject pending             | Admin                     | Community owner/moderator; platform override by Admin/site moderator | n/a                                          |
| Restore platform-unpublished post    | n/a                       | Admin/site moderator only                                            | n/a                                          |
| Pin (≤3)                             | n/a                       | Community owner/moderator, Admin                                     | n/a                                          |
| Clearance (approve/reject/in_review) | Admin/site moderator      | Admin/site moderator                                                 | Admin/site moderator                         |
