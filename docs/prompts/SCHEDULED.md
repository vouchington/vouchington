...
| [first-party-dependencies.md](scheduled/first-party-dependencies.md)     | First-party workaround root causes, upstream ownership, registry drift, deduplicated Filaments `dependencies` issues, and linked local removal work.                                         |
