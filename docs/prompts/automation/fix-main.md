...
concurrent work. Create or update one draft PR whose title begins with
`Automation fix: {{WORKFLOW_NAME}} @ {{COMMIT_SHA}}` and whose body includes the failing run,
