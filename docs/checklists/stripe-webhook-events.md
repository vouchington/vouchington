...
Canonical list of Stripe webhook events the application handles. The source of truth is the
`switch (event.type)` inside `handleStripeWebhookEvent` in
[`backend/services/stripe-webhook-processing/webhook-handlers.mts`](../../backend/services/stripe-webhook-processing/webhook-handlers.mts).
...
- Handler switch: [`backend/services/stripe-webhook-processing/webhook-handlers.mts`](../../backend/services/stripe-webhook-processing/webhook-handlers.mts)
