...
| ------------------------------------------------------------------------------ | ------------------------------------------------- | ---------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| `/_next/static/*`                                                              | HTTP: Next.js directly; HTTPS: same-origin Worker | Fixed logical `http://localhost` origin, mapped by Chromium to shard Next.js | CloudFront CDN via `NEXT_PUBLIC_ASSET_PREFIX`                    |
