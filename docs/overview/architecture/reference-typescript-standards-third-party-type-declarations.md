...
| `backend/types/lingua-rs.d.ts`                      | Removed     | Replaced by `lingua-rs`'s bundled types. Native installation was resolved separately (formerly filed as jonathanong/filaments#7809).                                                                                                                                  |
...
| `ci/no-mistakes-playwright.d.ts`                    | Removed     | After `no-mistakes` 0.32.0, the report is accepted as `unknown` and validated before its `edges` are read. The tracking issue (formerly filed as jonathanong/filaments#7799) was separately closed by [PR #7971](https://github.com/jonathanong/filaments/pull/7971). |
