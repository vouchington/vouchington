...
| ------------------------------- | -------- | ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `OPENAI_API_KEY`                | Yes      | SM          | OpenAI API key (direct moderation and reranking; retained agents use OpenRouter)                                                                                                                                                                 |
| `OPENROUTER_API_KEY`            | Yes      | SM          | OpenRouter key for retained-agent OpenResponses calls in backend and worker ECS tasks, plus the isolated credentialed OpenRouter and Jev structured-decisions test suites.                                                                       |
