...
| `OPENROUTER_API_KEY`            | No       | Local + CI  | OpenRouter key for retained-agent OpenResponses calls plus the isolated credentialed OpenRouter and Jev structured-decisions test suites.                                                                                                        |
