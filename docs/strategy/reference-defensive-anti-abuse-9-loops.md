...
| --------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------ |
| **Vote Integrity**                | Velocity spikes + IP correlation detection, reduced vote weight applied as an admin penalty                                                                                                                        | Built  |
...
| **New Account Suppression**       | Accounts < 7 days get sharply reduced vote weight, minimal/nearly zero ranking impact                                                                                                                              | Built  |
...
| **Vote-Ring Cascade Penalty**     | Admin flags a spammer → reduced vote weight applied to every upvoter of their content → all affected election stats re-enqueued for recompute → trust scores auto-correct. One admin action cascades network-wide. | Built  |
