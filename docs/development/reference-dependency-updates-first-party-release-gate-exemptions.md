...
| `@vouchington/localization`                   | First-party localization catalog contracts, locale fallback, and selector validation published by the repo author.                           | No                              |
| `@vouchington/localization-compiler`          | First-party localization JSON-to-SQLite compiler and Node resolver published by the repo author.                                             | No                              |
