...
app
  ...
  .get(async (ctx: Context) => {
    ...
    validateRequestContract(ctx, 'GET:/api/v1/communities/:idOrSlug/list-items/urls', {
      path: ctx.params,
    })
  ...
  .post(async (ctx: Context) => {
    ...
    validateRequestContract(ctx, 'POST:/api/v1/communities/:idOrSlug/list-items/urls', {
      path: ctx.params,
      body,
    })
...
app.route('/api/v1/communities/:idOrSlug/list-items/urls/:itemId').delete(async (ctx: Context) => {
  ...
  validateRequestContract(ctx, 'DELETE:/api/v1/communities/:idOrSlug/list-items/urls/:itemId', {
    path: ctx.params,
  })
