...
| ------------ | ----------------------------------------------------------- |
| `initialize` | Returns server capabilities and agent-facing `instructions` |
