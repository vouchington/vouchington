...
export async function insertBatchPostRelations(params: {
  ...
  await write(
    ...
    INSERT INTO posts (id, post_type, title, markdown, created_by_id, broadcast, privacy, is_anonymous, bedrock_nova_multimodal_v1_content_sha256, llm_moderation_content_sha256, created_via)
    SELECT unnest_id, 'discussion', 'Trending test post', 'test', ${userId}, 'everyone', 'public', false, ${sha256}, ${sha256}, 'system'
