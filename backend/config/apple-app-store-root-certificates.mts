const APPLE_INC_ROOT_CERTIFICATE = `-----BEGIN CERTIFICATE-----
...
export function getAppleAppStoreRootCertificates(): Buffer[] {
  return [APPLE_INC_ROOT_CERTIFICATE, APPLE_ROOT_CA_G2, APPLE_ROOT_CA_G3].map(certificate =>
