...
>({
  ...
  jobName: 'reconcile-runtime-generations',
})

export function enqueueReconcileRuntimeGenerations(): ReturnType<typeof enqueueReconcileJob> {
  return enqueueReconcileJob({}, {
    ...
    priority: AGENT_PRIORITY['reconcile-runtime-generations'],
