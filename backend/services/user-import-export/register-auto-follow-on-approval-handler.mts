import { registerRecommendationApprovedHandler } from '@services/topic-recommendations/recommendation-approved-handler-registry'
import { autoFollowOnRecommendationApproval } from './auto-follow-on-approval.mts'

// Registers this package's auto-follow logic as topic-recommendations' recommendation-
...
// Keeps topic-recommendations from depending on user-import-export.
