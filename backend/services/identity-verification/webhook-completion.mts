...
import { runVerifiedIdentityTransaction } from './webhook-completion-txn.mts'
...
export async function onVerificationSessionVerified(
  ...
  // extract documentNumber (requires_input from a verified webhook). Either way the user
