...
} from './webhook-checkout-handlers.mts'
import { handleChargeRefunded } from '@services/stripe/webhook-charge-handlers'
import { handleChargeDisputeClosed } from '@services/stripe/webhook-dispute-handlers'
import {
  handleInvoicePaymentPaid,
  handleSubscriptionDeleted,
  handleSubscriptionUpdated,
} from '@services/stripe/webhook-subscription-handlers'

type StripeWebhookEventDependencies = {
...
const defaultDependencies: StripeWebhookEventDependencies = {
  handleCheckoutSessionCompleted,
  handleCheckoutSessionPaymentFailed,
  handleInvoicePaid,
  handleInvoicePaymentFailure,
...
export async function handleStripeWebhookEvent(
  event: Stripe.Event,
  dependencies?: Partial<StripeWebhookEventDependencies>,
