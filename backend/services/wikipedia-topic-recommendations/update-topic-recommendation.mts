  ...
  try {
    ...
    const materialized = await materializeTopicRecommendationInput(
      currentUser.id,
      {
        ...
        topic_wikipedia_pageid:
          changes.topic_wikipedia_pageid !== undefined
            ? changes.topic_wikipedia_pageid
            : ((lockedRecommendation.topic_wikipedia_pageid as string | null) ?? undefined),
        topic_type:
          changes.topic_type ??
    ...
    const extensionResult = await write(
      sql`/* updateTopicRecommendation */
          ...
          SET topic_title = ${materialized.topic_title},
            ...
            topic_wikipedia_pageid = ${materialized.topic_wikipedia_pageid},
