...
import { handleStripeEvent } from './event-handlers.mts'
...
describe('handleStripeEvent', () => {
  ...
  it('routes invoice_payment.paid by InvoicePayment invoice and provider environment', async () => {
    ...
    const result = await handleStripeEvent(makeEvent('invoice_payment.paid', eventData), {
  ...
  it('routes customer.subscription.deleted to handleSubscriptionDeleted', async () => {
    ...
    const result = await handleStripeEvent(makeEvent('customer.subscription.deleted', eventData), {
  ...
  it.each([
    ...
    const result = await handleStripeEvent(makeEvent(type, eventData), {
  ...
  it('routes charge.refunded with its provider environment', async () => {
    ...
    const result = await handleStripeEvent(makeEvent('charge.refunded', eventData), {
  ...
  it.each(['charge.dispute.closed', 'charge.dispute.funds_reinstated'])(
    ...
    async eventType => {
      ...
      const result = await handleStripeEvent(makeEvent(eventType, eventData), {
