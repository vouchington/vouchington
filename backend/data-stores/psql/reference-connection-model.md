...
`STATEMENT` line only flooded the runner's service-container log. In CI runs measured before and
after the change, that log fell from 826–1,900 lines per job to 69–85.
