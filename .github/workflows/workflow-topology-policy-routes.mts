...
export const routePolicy = {
  ...
  requiredDirectEdges: [
    ...
    edge(mainWebJob('test-web'), mainWebJob('test-web-api')),
    edge(mainWebJob('test-web'), mainWebJob('test-web-integration')),
    edge(mainWebJob('test-web'), mainWebJob('playwright-tests')),
    edge(mainWebJob('test-web'), mainWebJob('playwright-credentialed-tests')),
    edge(mainWebJob('test-web-api'), mainWebJob('playwright-tests')),
    edge(mainWebJob('test-web-api'), mainWebJob('playwright-credentialed-tests')),
    edge(mainWebJob('test-web-integration'), mainWebJob('playwright-tests')),
    edge(mainWebJob('test-web-integration'), mainWebJob('playwright-credentialed-tests')),
    edge(
