...
const readyDedupeWorkflowText = readFileSync('.github/workflows/ci-ready-dedupe.yml', 'utf8')
export const readyDedupeScriptText = readFileSync('ci/ready-dedupe.sh', 'utf8')
