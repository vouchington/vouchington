...
| [`jscpd/`](jscpd/)                                                         | Docs and wiring test for the plain `jscpd` CLI gate: fails on any clone at or above the `.jscpd.json` `minLines` threshold. See the [jscpd clone-size threshold](jscpd/README.md) for lowering the threshold, ignore globs, and the exceptions table.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
