...
| [`jscpd/`](jscpd/)                                                         | Modules and tests for [`run-jscpd.mts`](run-jscpd.mts), the `jscpd` new-clone ratchet: fails when a branch adds duplicated code its merge-base lacks. See the [jscpd duplication ratchet](jscpd/README.md) for base selection, ignore globs, and the exceptions table.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
