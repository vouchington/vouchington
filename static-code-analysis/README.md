...
| [`jscpd/`](jscpd/)                                                         | Modules and tests for [`run-jscpd.mts`](run-jscpd.mts), the `jscpd` new-clone ratchet: fails when a branch adds duplicated code its base lacks. See the [jscpd duplication ratchet](jscpd/README.md) for base selection, ignore globs, and the exceptions table.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
...
| [`scc-complexity/`](scc-complexity/)                                       | Runs pinned `scc` once over the repository. Test/spec files, fixtures, and `test-helpers` directories are excluded. Every remaining tracked file must stay at or under complexity 50. There is no tooling baseline.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
- `pnpm run jscpd` (or `pnpm run jscpd --base <parent-branch>` on a stacked branch) for new duplicated code.
