...
describe('findProjectCompletionSiblings', () => {
  it('respects the exact PROJECT_COMPLETION_REMAINDER boundary', () => {
    expect(PROJECT_COMPLETION_REMAINDER).toBe(3)
  })
  ...
  it('reports remaining open items excluded by the closed-by-this-PR key set', async () => {
  ...
  it('stays silent once the remainder exceeds the threshold', async () => {
