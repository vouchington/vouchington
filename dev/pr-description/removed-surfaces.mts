...
function parseRemovedExports(block: string, path: string): RemovedSurface[] {
...
function addNamedExportNames(raw: string, into: Set<string>): void {
...
function collectExportNames(content: string, into: Set<string>): void {
